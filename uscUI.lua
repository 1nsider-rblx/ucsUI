...
coroutine.wrap(ZEXJI_fake_script)()
local function HFKUL_fake_script() -- jp.LocalScript 
...
coroutine.wrap(HFKUL_fake_script)()
local function MQZXJHV_fake_script() -- hp.LocalScript 
...
coroutine.wrap(MQZXJHV_fake_script)()
local function BQWS_fake_script() -- sit.LocalScript 
...
coroutine.wrap(BQWS_fake_script)()
local function DWZTAN_fake_script() -- stone.LocalScript 
...
coroutine.wrap(DWZTAN_fake_script)()
local function OXRFO_fake_script() -- bps.LocalScript 
...
coroutine.wrap(OXRFO_fake_script)()
local function FACMFM_fake_script() -- removeacs.LocalScript 
...
coroutine.wrap(FACMFM_fake_script)()
local function OOLYGY_fake_script() -- dplayer.LocalScript 
...
coroutine.wrap(OOLYGY_fake_script)()
local function IFHHQ_fake_script() -- delbp.LocalScript 
...
coroutine.wrap(IFHHQ_fake_script)()
local function OFGSRJM_fake_script() -- dgui.LocalScript 
...
coroutine.wrap(OFGSRJM_fake_script)()
local function NXPVA_fake_script() -- freeze.LocalScript 
...
coroutine.wrap(NXPVA_fake_script)()
local function VDOP_fake_script() -- dispr.LocalScript 
...
coroutine.wrap(VDOP_fake_script)()
local function JKEHC_fake_script() -- dbpc.LocalScript 
...
coroutine.wrap(JKEHC_fake_script)()
local function VQGMER_fake_script() -- plate.LocalScript 
...
coroutine.wrap(VQGMER_fake_script)()
local function PWCKPAF_fake_script() -- clone.LocalScript 
...
coroutine.wrap(PWCKPAF_fake_script)()
local function MNRO_fake_script() -- btools.LocalScript 
...
coroutine.wrap(MNRO_fake_script)()
local function ONRT_fake_script() -- tp.LocalScript 
...
coroutine.wrap(ONRT_fake_script)()
local function PRLP_fake_script() -- tpp.LocalScript 
...
coroutine.wrap(PRLP_fake_script)()
local function NTFQ_fake_script() -- infY.LocalScript 
...
coroutine.wrap(NTFQ_fake_script)()
local function LZQZQGY_fake_script() -- top.draggable 
...
coroutine.wrap(LZQZQGY_fake_script)()
